# solution copied from https://leetcode.com/problems/maximum-number-of-tasks-you-can-assign/discuss/1620435/Python-3-solution

# very hard problem - only for good to know
